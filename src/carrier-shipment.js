...
function buildCarrierShipmentXml({ asn, po, sku, skuQty, carrier = "DT", now, sequence }) {
  ...
  const shipmentCaBlock = carrierProfile.vbkconCaIdQualifier
